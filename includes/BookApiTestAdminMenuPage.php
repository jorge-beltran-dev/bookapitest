...
class BookApiTestAdminMenuPage
{
    public function __construct()
    {
        add_action('admin_menu', [&$this, 'bookapitest_register_submenu']);
        add_action('admin_init', [&$this, 'bookapitest_register_settings']);
    }

    public function bookapitest_register_submenu() {
        add_submenu_page( 
            'options-general.php', 'BookApiTest settings', 'BookApiTestSettings', 'manage_options', 'book-api-test', [&$this, 'bookapitest_submenu_page_callback']
        );
    }

    public function bookapitest_submenu_page_callback() {
    ...
    public function bookapitest_register_settings() {
